  ...
  function tampil_data($koneksi)
  {
    ...
    ?>
      <tr>
        ...
        <td><a href="index.php?aksi=update&id=<?= $data['id'] ?>&nama=<?= $data['nama_tanaman'] ?>&hasil=<?= $data['hasil_panen'] ?>&lama=<?= $data['lama_tanam'] ?>&tanggal=<?= $data['tanggal_panen'] ?>">Ubah</a> | <a href="">Hapus</a></td>
      </tr>
    <?php
    }
    echo "</table>";
  ...
  function ubah($koneksi)
  {
    ...
    if (isset($_POST['btn_ubah'])) {
      ...
      if (!empty($nm_tanaman) && !empty($hasil) && !empty($lama) && !empty($tgl_panen)) {
        $sql_update = "UPDATE tabel_panen SET
        nama_tanaman = '$nm_tanaman', hasil_panen = '$hasil',
        lama_tanam = '$lama', tanggal_panen = '$tgl_panen'
        WHERE id = '$id'";
